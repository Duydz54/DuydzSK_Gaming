...
Title = "Script By: DuydzSkGaming", -- dont skid ðŸ™ ðŸ’”
Text = "Đang chạy trên dead rail",
Duration = 3
})
local screenGui = Instance.new("ScreenGui")
screenGui.Name = "AimBot_NPC_DuydzSK"
screenGui.Parent = game:GetService("CoreGui")
local button = Instance.new("TextButton")
button.Name = "AimBotSK: Mở/Khoá"
button.Size = UDim2.new(0, 150, 0, 50)
button.Position = UDim2.new(0.5, -75, 0.9, -25)
button.BackgroundColor3 = Color3.new(0, 0, 0)
button.TextColor3 = Color3.new(1, 1, 1)
button.Text = "Ba Mầy Gầy: Khoá"
